                ...
                <div className="mx-auto max-w-3xl text-center mb-20">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl lg:text-6xl mb-6">
                            ...
                            <span className="bg-gradient-to-r from-indigo-500 to-purple-500 bg-clip-text text-transparent">not code.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Button size="lg" className="w-full sm:w-auto font-semibold bg-indigo-500 hover:bg-indigo-600" asChild>
                                <Link href="/docs">
                                    Get Started <ArrowRight className="ml-2 h-4 w-4" />
                                </Link>
                            </Button>
                            <Button size="lg" variant="outline" className="w-full sm:w-auto border-border/60" asChild>
                        ...
                        <div className="mt-10 flex justify-center">
                            <div className="flex items-center gap-3 px-5 py-2.5 rounded-full bg-zinc-900 border border-zinc-800 text-sm font-mono">
                                ...
                                <button
                                    ...
                                    onClick={() => navigator.clipboard.writeText("pnpm add @fluxmedia/core @fluxmedia/s3")}
                                >
